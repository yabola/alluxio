...
public final class BlockWorkerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<alluxio.grpc.KylinDataRequest,
          alluxio.grpc.KylinDataResponse> getMarkEvictorMethod;

  @io.grpc.stub.annotations.RpcMethod(
          fullMethodName = SERVICE_NAME + '/' + "markEvictor",
          requestType = alluxio.grpc.KylinDataRequest.class,
          responseType = alluxio.grpc.KylinDataResponse.class,
          methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<alluxio.grpc.KylinDataRequest,
          alluxio.grpc.KylinDataResponse> getMarkEvictorMethod() {
    io.grpc.MethodDescriptor<alluxio.grpc.KylinDataRequest, alluxio.grpc.KylinDataResponse> getMarkEvictorMethod;
    if ((getMarkEvictorMethod = BlockWorkerGrpc.getMarkEvictorMethod) == null) {
      synchronized (BlockWorkerGrpc.class) {
        if ((getMarkEvictorMethod = BlockWorkerGrpc.getMarkEvictorMethod) == null) {
          BlockWorkerGrpc.getMarkEvictorMethod = getMarkEvictorMethod =
                  io.grpc.MethodDescriptor.<alluxio.grpc.KylinDataRequest, alluxio.grpc.KylinDataResponse>newBuilder()
                          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                          .setFullMethodName(generateFullMethodName(SERVICE_NAME, "markEvictor"))
                          .setSampledToLocalTracing(true)
                          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                  alluxio.grpc.KylinDataRequest.getDefaultInstance()))
                          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                  alluxio.grpc.KylinDataResponse.getDefaultInstance()))
                          .setSchemaDescriptor(new BlockWorkerMethodDescriptorSupplier("markEvictor"))
                          .build();
        }
      }
    }
    return getMarkEvictorMethod;
  }
  ...
  public static abstract class BlockWorkerImplBase implements io.grpc.BindableService {
    ...
    public void markEvictor(alluxio.grpc.KylinDataRequest request,
      ...
      asyncUnimplementedUnaryCall(getMarkEvictorMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
              ...
              .addMethod(
                      getMarkEvictorMethod(),
                      asyncUnaryCall(
                              new MethodHandlers<
                                      alluxio.grpc.KylinDataRequest,
                                      alluxio.grpc.KylinDataResponse>(
                                      this, METHODID_MARK_EVICTOR)))
              .build();
    }
  }
  ...
  public static final class BlockWorkerStub extends io.grpc.stub.AbstractAsyncStub<BlockWorkerStub> {
    ...
    public void markEvictor(alluxio.grpc.KylinDataRequest request,
                            io.grpc.stub.StreamObserver<alluxio.grpc.KylinDataResponse> responseObserver) {
      asyncUnaryCall(
              getChannel().newCall(getMarkEvictorMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class BlockWorkerBlockingStub extends io.grpc.stub.AbstractBlockingStub<BlockWorkerBlockingStub> {
    ...
    /**
     */
    public alluxio.grpc.KylinDataResponse markEvictor(alluxio.grpc.KylinDataRequest request) {
      return blockingUnaryCall(
              getChannel(), getMarkEvictorMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class BlockWorkerFutureStub extends io.grpc.stub.AbstractFutureStub<BlockWorkerFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<alluxio.grpc.KylinDataResponse> markEvictor(
            alluxio.grpc.KylinDataRequest request) {
      return futureUnaryCall(
              getChannel().newCall(getMarkEvictorMethod(), getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_MARK_EVICTOR = 4;
  private static final int METHODID_READ_BLOCK = 5;
  private static final int METHODID_WRITE_BLOCK = 6;
  private static final int METHODID_OPEN_LOCAL_BLOCK = 7;
  private static final int METHODID_CREATE_LOCAL_BLOCK = 8;
      ...
      switch (methodId) {
        ...
        case METHODID_CLEAR_METRICS:
          serviceImpl.clearMetrics((alluxio.grpc.ClearMetricsRequest) request,
                  (io.grpc.stub.StreamObserver<alluxio.grpc.ClearMetricsResponse>) responseObserver);
          break;
        case METHODID_MARK_EVICTOR:
          serviceImpl.markEvictor((alluxio.grpc.KylinDataRequest) request,
                  (io.grpc.stub.StreamObserver<alluxio.grpc.KylinDataResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (BlockWorkerGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
                  ...
                  .addMethod(getMarkEvictorMethod())
                  .build();
        }
      }
    }
